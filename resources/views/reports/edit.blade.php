...
@section('content')
    ...
    <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href = "{{ route('reports.show', ['user_id'=>$user->id, 'report'=>$report->id]) }}">{{$report->date}}のからだレポート</a></li>
                <li class="breadcrumb-item active" aria-current="page">編集ページ</li>
            </ol>
        </nav>
    
    <h3>{{ $user->name }}様のからだレポート編集ページ</h3>
    
    {!! Form::model($report, ['route'=>['reports.update', $user_id, $report], 'method'=>'put']) !!}
        ...
        <div class="text-center">
            {!! Form::submit('更新', ['class' => 'btn btn-lg mb-3']) !!}
        </div>
    {!! Form::close() !!}
